	...
	<div class="container">
		<form method="post" action="mypageUpdate.jsp">
			...
			<table class="table">
				...
				<tr>
					<td>Password</td>
					<td><input id="pass" placeholder="비밀번호" type="text" class="form-control"></td>
				</tr>
				<tr>
					<td>Passwd confirm</td>
					<td><input id="passcon" placeholder="비밀번호 확인" type="text" class="form-control"></td>
				</tr>
				<tr>
					<td>Email</td>
				...
				<tr>
					<td>Blog</td>
					<td><input id="blog" type="text" class="form-control"
						value="<%=dto.getBlog()%>" readonly></td>
				</tr>
				<tr>
					<td>가입일</td>
					<td><input id="date" type="text" class="form-control"
						value="<%=dto.getReg_date()%>" readonly></td>
				</tr>
			</table>
			<div>
